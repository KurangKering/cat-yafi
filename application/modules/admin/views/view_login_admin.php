...
<body class="hold-transition register-page">
  <div class="register-box">
    <div class="register-logo">
      <a href="<?php echo site_url('assets/templates/AdminLTE-2.4.5/'); ?>/index2.html"><b>Login</b> Page</a>
    </div>
    ...
    <div class="register-box-body">
      ...
      <?php if (isset($error)): ?>
        ...
        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button><?php echo isset($error) ? $error : '' ?></div>
      <?php endif ?>
      <form " method="post">
